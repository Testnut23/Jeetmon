  ...
  characters = [
    {
      ...
      resistance: ['steel'],
      img: {
        default: "https://i.ibb.co/z2vHj3D/w-VBr-T2-Sv-400x400.jpg",
        front: "https://i.ibb.co/z2vHj3D/w-VBr-T2-Sv-400x400.jpg",
        back: "https://i.ibb.co/z2vHj3D/w-VBr-T2-Sv-400x400.jpg"
      },
      hp: {
        current: 500,
        total: 500
    ...
    },
    {
      ...
      resistance: ['grass'],
      img: {
        default: "https://i.ibb.co/GnmkNhR/GO3tu8e-X-400x400.jpg",
        front: "https://i.ibb.co/GnmkNhR/GO3tu8e-X-400x400.jpg",
        back: "https://i.ibb.co/GnmkNhR/GO3tu8e-X-400x400.jpg"
      },
      hp: {
        current: 500,
        total: 500
    ...
    },
    {
      ...
      img: {
        default: "https://i.ibb.co/z5DDMGM/z-UGXg4-ME-400x400.jpg",
        front: "https://i.ibb.co/z5DDMGM/z-UGXg4-ME-400x400.jpg",
        back: "https://i.ibb.co/z5DDMGM/z-UGXg4-ME-400x400.jpg"
      },
      hp: {
        current: 500,
        total: 500
    ...
    },
    {
      ...
      img: {
        default: "https://i.ibb.co/2hW00YH/GMMgd-J4-XEAAJs-d-removebg-preview.png",
        front: "https://i.ibb.co/2hW00YH/GMMgd-J4-XEAAJs-d-removebg-preview.png",
        back: "https://i.ibb.co/2hW00YH/GMMgd-J4-XEAAJs-d-removebg-preview.png",
        deranged: "https://i.ibb.co/2hW00YH/GMMgd-J4-XEAAJs-d-removebg-preview.png",
        sleep: "https://i.ibb.co/2hW00YH/GMMgd-J4-XEAAJs-d-removebg-preview.png"
      },
      hp: {
        current: 500,
        total: 500
    ...
    },
    {
      ...
      resistance: [],
      img: {
        default: "https://i.ibb.co/0Yx891v/GMb1-EWKWMAI7-q-Z-removebg-preview.png",
        front: "https://i.ibb.co/0Yx891v/GMb1-EWKWMAI7-q-Z-removebg-preview.png",
        back:  "https://i.ibb.co/0Yx891v/GMb1-EWKWMAI7-q-Z-removebg-preview.png"
      },
      hp: {
        current: 500,
        total: 500
...
function resetGame(){
  ...
  $('.instructions p').text('Choose your Jeeter');
...
function attackEnemy(that, callback){
  ...
  if(curAttack.avail.remaining > 0){
    ...
    if(gameData.enemy.hp.current <= 0){
      ...
      clearModal();
    $('.modal-in header').append('<h1>Your Enemy has been rugged</h1><span class="close">x</span>');
